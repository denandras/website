      ...
      <header className="sticky top-0 z-50 border-b border-neutral-border bg-background-dark/80 backdrop-blur-md">
        <div className="flex h-16 w-full items-center justify-center px-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-display text-lg font-bold tracking-tight uppercase">Get in Touch</h1>
          </div>
        </div>
      </header>
                ...
                <div data-reveal style={{ ["--reveal-delay" as any]: "120ms" }}>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs font-bold tracking-widest text-primary uppercase">Email</p>
                ...
                <div data-reveal style={{ ["--reveal-delay" as any]: "180ms" }}>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs font-bold tracking-widest text-primary uppercase">Phone</p>
                ...
                <div data-reveal style={{ ["--reveal-delay" as any]: "240ms" }}>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-xs font-bold tracking-widest text-primary uppercase">Instagram</p>
                ...
                <div data-reveal style={{ ["--reveal-delay" as any]: "120ms" }}>
                  <section className="rounded-2xl border border-neutral-border bg-neutral-dark/40 p-6">
                    <form action="https://formsubmit.co/contact@andrasdenes.com" method="POST" className="space-y-4" noValidate>
                      <input type="hidden" name="_subject" value="New booking inquiry from andrasdenes.com" />
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-neutral-300" htmlFor="contact-name">Name</label>
                          <input
                            id="contact-name"
                            name="name"
                            type="text"
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-neutral-300" htmlFor="contact-email">Email Address</label>
                          <input
                            id="contact-email"
                            name="email"
                            type="email"
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-neutral-300" htmlFor="contact-message">Message</label>
                        <textarea
                          id="contact-message"
                          name="message"
                          rows={4}
